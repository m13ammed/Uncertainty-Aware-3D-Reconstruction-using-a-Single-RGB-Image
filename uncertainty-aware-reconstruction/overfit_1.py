...
comment = "overtfit_l1_1_lr_1e-4_10k_dropout02"
...
#log_dir = "/mnt/hdd/tmp_new/logs_new2/Aug21_17-36-40_overtfit_l1_1_lr_3e-6_10k/"
...
train_dataloader = data.DataLoader(train_dataset, batch_size= 4, collate_fn=collate_function, shuffle= True, drop_last= True, num_workers= 8)
val_dataset = Front3D_Obj(num_samples = 1000, split = 'val')
val_dataloader = data.DataLoader(val_dataset, batch_size= 4, collate_fn=collate_function, shuffle= False, drop_last= False, num_workers= 8)
...
start_epoch = 0
checkpoint_path = "/mnt/hdd/tmp_new/logs_new2/Aug21_17-36-40_overtfit_l1_1_lr_3e-6_10k/checkpoint_24.pt"  # Provide the path to the saved checkpoint
checkpoint_path = ""
...
for epoch in range(start_epoch,5000):
    ...
    for i,batch in enumerate(train_dataloader):
        ...
        (fine1, fine, coarse), (gt,gt_fine1, gt_coarse), (loss3, loss2, loss1), total_train_loss = model(inputs,gt,  is_training=True, mask = mask)
